        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold text-blue-600">마인드맵</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative bg-gradient-to-br from-blue-50 to-purple-50 rounded-[24px] p-8 border border-gray-200 shadow-2xl">
                ...
                <div className="relative w-full aspect-video bg-white rounded-[16px] border-2 border-gray-300 overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-500">마인드맵 GIF</p>
                    </div>
                  </div>
                  {/* 브라우저 프레임 효과 */}
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 mb-1">직관적인 노드 편집</p>
                    <p className="text-gray-600 text-sm">더블클릭으로 즉시 수정하고, 드래그로 자유롭게 배치하세요</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 mb-1">무한 확장 가능</p>
                    <p className="text-gray-600 text-sm">원하는 만큼 하위 노드를 추가하여 세부 경험을 기록하세요</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 mb-1">AI와 함께 구조화</p>
                    <p className="text-gray-600 text-sm">노드를 선택하면 AI 어시스턴트가 STAR 방식으로 경험을 정리해줍니다</p>
                  </div>
                </li>
              </ul>
            </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 bg-blue-50 rounded-[12px] flex items-center justify-center mb-4">
