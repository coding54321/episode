...
export default function ArchiveFeaturePage() {
  ...
  const { user } = useUnifiedAuth(); // 전역 상태에서 사용자 정보 가져오기
    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
      ...
      <section className="px-5 pt-32 pb-20 md:pt-40 md:pb-32">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 dark:bg-green-900/30 rounded-full mb-6">
              <Archive className="w-5 h-5 text-green-600 dark:text-green-400" />
              <span className="text-sm font-semibold text-green-600 dark:text-green-400">에피소드 아카이브</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-[24px] p-8 border border-gray-200 dark:border-[#2a2a2a] shadow-2xl">
                ...
                <div className="relative w-full aspect-video bg-white dark:bg-[#1a1a1a] rounded-[16px] border-2 border-gray-300 dark:border-[#2a2a2a] overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <Archive className="w-16 h-16 text-gray-400 dark:text-[#606060] mx-auto mb-4" />
                      <p className="text-sm text-gray-500 dark:text-[#a0a0a0]">에피소드 아카이브 GIF</p>
                    </div>
                  </div>
                  {/* 브라우저 프레임 효과 */}
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-[#e5e5e5] mb-1">계층적 구조 표시</p>
                    <p className="text-gray-600 dark:text-[#a0a0a0] text-sm">프로젝트, 대분류, 경험을 병합하여 표시하여 중복을 제거하고 가독성을 높입니다</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-[#e5e5e5] mb-1">인라인 편집</p>
                    <p className="text-gray-600 dark:text-[#a0a0a0] text-sm">테이블에서 직접 STAR 필드와 태그를 편집하여 즉시 마인드맵에 반영됩니다</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-[#e5e5e5] mb-1">통합 관리</p>
                    <p className="text-gray-600 dark:text-[#a0a0a0] text-sm">여러 마인드맵의 에피소드를 한 곳에서 관리하여 전체 경험을 종합적으로 파악할 수 있습니다</p>
                  </div>
                </li>
              </ul>
            </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 bg-green-50 dark:bg-green-900/30 rounded-[12px] flex items-center justify-center mb-4">
