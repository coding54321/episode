...
function LandingContent() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xs md:text-sm text-gray-500 tracking-wider uppercase font-medium"
            >
              당신의 모든 경험을 잇다
            </motion.p>
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl lg:text-8xl font-bold text-gray-900 tracking-tight leading-[1.1] px-4"
            ...
            <motion.p
              ...
              className="text-lg md:text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-normal px-4"
            >
            ...
            >
              ...
              <motion.button
                ...
                className="px-7 py-3.5 bg-white border-2 border-gray-200 rounded-lg text-gray-700 font-semibold text-base transition-all duration-300 cursor-pointer"
                whileHover={{
                  scale: 1.02,
                  borderColor: '#5B6EFF'
                }}
      ...
      {/* 기능 소개 */}
      <section id="features-section" className="px-5 py-24 border-t border-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 tracking-tight flex items-center justify-center gap-3 flex-wrap">
              취업준비{' '}
              <span className="inline-block px-4 py-2 bg-gray-100 border-2 border-gray-300 rounded-xl text-inherit">
                소스
              </span>
              {' '}정리,{' '}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="space-y-3 pt-4">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#5B6EFF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#5B6EFF]" />
                    </div>
                    <p className="text-gray-700">배지별 경험 분류 및 시각적 구조화</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#5B6EFF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#5B6EFF]" />
                    </div>
                    <p className="text-gray-700">드래그 앤 드롭으로 자유로운 배치</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#5B6EFF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#5B6EFF]" />
                    </div>
                    <p className="text-gray-700">실시간 협업 및 공유 기능</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#5B6EFF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#5B6EFF]" />
                    </div>
                    <p className="text-gray-700">다양한 레이아웃 옵션 (원형, 트리형)</p>
                  </div>
                </div>
                <div className="pt-4">
                  <motion.button
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="relative w-full max-w-md">
                  ...
                  <div className="relative bg-gradient-to-br from-[#5B6EFF]/10 to-[#7B8FFF]/20 rounded-3xl p-8 border-2 border-[#5B6EFF]/30 backdrop-blur-sm">
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center shadow-md border border-[#5B6EFF]/20">
                        <Layers className="w-8 h-8 text-[#5B6EFF]" />
                      </div>
                      <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center shadow-md border border-[#5B6EFF]/20">
                        <Layout className="w-8 h-8 text-[#5B6EFF]" />
                      </div>
                      <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center shadow-md border border-[#5B6EFF]/20">
                        <Share2 className="w-8 h-8 text-[#5B6EFF]" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          >
            <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-16">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="space-y-3 pt-4">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#4B5EEF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#4B5EEF]" />
                    </div>
                    <p className="text-gray-700">주요 기업별 자소서 문항 분석</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#4B5EEF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#4B5EEF]" />
                    </div>
                    <p className="text-gray-700">답변 어려움 정도 평가 시스템</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#4B5EEF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#4B5EEF]" />
                    </div>
                    <p className="text-gray-700">자동 역량 태그 추출 및 관리</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#4B5EEF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#4B5EEF]" />
                    </div>
                    <p className="text-gray-700">추천 인벤토리로 바로 추가</p>
                  </div>
                </div>
                <div className="pt-4">
              <motion.button
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="relative w-full max-w-md">
                  ...
                  <div className="relative bg-gradient-to-br from-[#4B5EEF]/10 to-[#6B7EFF]/20 rounded-3xl p-8 border-2 border-[#4B5EEF]/30 backdrop-blur-sm">
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-md border border-[#4B5EEF]/20">
                          <Search className="w-6 h-6 text-[#4B5EEF]" />
                        </div>
                        <div className="flex-1 h-12 bg-white rounded-xl flex items-center px-4 shadow-md border border-[#4B5EEF]/20">
                          <div className="w-full h-2 bg-[#4B5EEF]/20 rounded-full">
                            <div className="w-3/4 h-2 bg-gradient-to-r from-[#4B5EEF] to-[#6B7EFF] rounded-full" />
                          </div>
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="h-16 bg-white rounded-xl flex items-center justify-center shadow-md border border-[#4B5EEF]/20">
                          <Tag className="w-6 h-6 text-[#4B5EEF]" />
                        </div>
                        <div className="h-16 bg-white rounded-xl flex items-center justify-center shadow-md border border-[#4B5EEF]/20">
                          <FileText className="w-6 h-6 text-[#4B5EEF]" />
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          >
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="space-y-3 pt-4">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#8B9FFF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#8B9FFF]" />
                    </div>
                    <p className="text-gray-700">STAR 구성 요소별 체계적 작성</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#8B9FFF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#8B9FFF]" />
                    </div>
                    <p className="text-gray-700">프로젝트/카테고리별 필터링</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#8B9FFF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#8B9FFF]" />
                    </div>
                    <p className="text-gray-700">태그 기반 검색 및 관리</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#8B9FFF]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-[#8B9FFF]" />
                    </div>
                    <p className="text-gray-700">한눈에 보는 경험 목록</p>
                  </div>
                </div>
                <div className="pt-4">
                  <motion.button
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="relative w-full max-w-md">
                  ...
                  <div className="relative bg-gradient-to-br from-[#8B9FFF]/10 to-[#ABAFFF]/20 rounded-3xl p-8 border-2 border-[#8B9FFF]/30 backdrop-blur-sm">
                    <div className="space-y-3">
                      <div className="h-12 bg-white rounded-xl flex items-center px-4 shadow-md border border-[#8B9FFF]/20">
                        <Grid3x3 className="w-5 h-5 text-[#8B9FFF] mr-3" />
                        <div className="flex-1 text-sm text-gray-500">검색...</div>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="h-20 bg-white rounded-xl p-3 shadow-md border border-[#8B9FFF]/20">
