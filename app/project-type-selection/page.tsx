  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] flex flex-col">
      ...
      <div className="flex-1 bg-white dark:bg-[#0a0a0a] px-5 py-6">
        <button
          onClick={handleBack}
          className="flex items-center gap-2 text-gray-600 dark:text-[#a0a0a0] mb-8 hover:text-gray-900 dark:hover:text-[#e5e5e5] transition-colors"
        >
              ...
              <motion.button
                ...
                className={`relative w-full h-[100px] rounded-[20px] border-[2px] transition-all duration-200 ease-out ${
                  selectedType === 'personal'
                    ? 'bg-blue-50 dark:bg-blue-900/30 border-blue-500 dark:border-[#60A5FA] shadow-lg scale-[1.02]'
