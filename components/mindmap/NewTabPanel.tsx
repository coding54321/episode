...
export default function NewTabPanel({ currentProjectId, onOpenProject, onCreateProject }: Props) {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-8 py-8 bg-gray-50 dark:bg-[#0a0a0a]">
        ...
        <div className="mb-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-[#e5e5e5]">개인 마인드맵</span>
            </button>
            <button
              ...
              {filteredRecent.map((proj) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-semibold text-gray-900 dark:text-[#e5e5e5] truncate mb-1">{proj.name}</div>
